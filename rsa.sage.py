...
_sage_const_2 = Integer(2); _sage_const_1024 = Integer(1024); _sage_const_0 = Integer(0); _sage_const_8 = Integer(8); _sage_const_1 = Integer(1)
...
class RSA(object):
    ...
    def session_key(self):
        ...
        self.m = [int(binary[i:i+_sage_const_1024 ], _sage_const_2 ) for i in range(_sage_const_0 , len(binary), _sage_const_1024 )]
    ...
    def __ColculationSecretExponent(self, Fi):
        self.d = mod(xgcd(self.e, Fi)[_sage_const_1 ], Fi)
